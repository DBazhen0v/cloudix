...
SEED_PLANS = [
    ...
    (
        ...
        "3 GB RAM DDR3-DDR5, Безлимит vCPU @ 3.1-5.4 GHz, 24 GB SSD NVMe, Базы данных MySQL: 8, Управление через Telegram-бота, 1-10 Gbit/s Network, Бэкапы: 5 шт., Приоритетная поддержка, Защита от DDoS",
        "179 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "0.9 vCPU, 300 MB RAM, 2 GB SSD NVMe, 1 поддомен, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 1 шт.",
        "19 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "0.9 vCPU, 300 MB RAM, 5 GB SSD NVMe, 1 поддомен, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 3 шт.",
        "29 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "0.9 vCPU, 400 MB RAM, 10 GB SSD NVMe, 1 поддомен, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 5 шт.",
        "49 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "Безлимит vCPU, 1024 MB RAM, 15 GB SSD NVMe, 5 поддоменов, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 1 шт.",
        "79 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "Безлимит vCPU, 1024 MB RAM, 20 GB SSD NVMe, 10 поддоменов, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 3 шт.",
        "99 ₽/мес",
    ),
    (
        "Веб-хостинг",
        ...
        "Безлимит vCPU, 1024 MB RAM, 30 GB SSD NVMe, 10 поддоменов, SSL-сертификат Let's Encrypt, Управление через Telegram-бота, Защита от DDoS, Бэкапы: 5 шт., Приоритетная поддержка",
        "149 ₽/мес",
    ),
    (
        "Minecraft-сервера",
